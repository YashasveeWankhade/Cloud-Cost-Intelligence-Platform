...
```
                     ...
                     └──┬──────┬──────┬──────┬─────────┘
                        │      │      │      │
          ┌─────────────▼─┐  ┌─▼──┐ ┌─▼──┐ ┌─▼──────────────────┐
          │ Auth Service  │  │Cost│ │Ana-│ │Recommendation Svc  │
          │ :8081         │  │Svc │ │lyti│ │:8084 (Gemini AI)   │
          │ auth_db       │  │:82 │ │cs  │ │recommendation_db   │
          └───────────────┘  │cost│ │Svc │ └────────────────────┘
                             │_db │ │:83 │
                             └──┬─┘ │ana-│   ┌────────────────────┐
                                │   │lyt-│   │ Notification Svc   │
                           ┌────▼───▼ics─▼───▼──:8085             │
                           │         KAFKA          notification_db │
                           │  cost-data             └──────┬───────┘
                           │  anomaly-events               │ SSE
                           │  root-cause-events            │
